...
class TestUser(unittest.TestCase):
    ...
    def test_user_name_attr(self):
        """Test that User has attr user_name, and it's an empty string"""
        user = User()
        self.assertTrue(hasattr(user, "user_name"))
    ...
    def test_phone_number_attr(self):
        """Test that User has attr phone_number, and it's an empty string"""
        user = User()
    ...
    def test_gender_attr(self):
        """Test that User has attr gender, and it's an empty string"""
        user = User()
        self.assertTrue(hasattr(user, "gender"))
        self.assertEqual(user.gender, None)

    def test_birthdate_attr(self):
        """Test that User has attr birthdate, and it's an empty string"""
        user = User()
        self.assertTrue(hasattr(user, "birthdate"))
